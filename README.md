...
### 2. Guided Usage
- **Identity Sync**: Enter your name and select your avatar to initialize your Voyager profile.
...
> 1. **The Map View**: Capturing the Liquid Glass badge and the map.
> 2. **The About Us Section**: Showcasing the moving grid and the Team IRREG illustration.
> 3. **The Sync Loader**: An action shot of the 100% calibration effect.

**Where to put them**:
Save your images in the `assets/screenshots/` folder. Then, replace the placeholder links in this README with your local paths, like this:
`![Description](assets/screenshots/your-image.png)`
